...
class BooksTableViewController: UITableViewController {
    var fetchedResultController = NSFetchedResultsController<Books>() //vantangem o delegate sera informado a cada interacao
    
    var label = UILabel()
    
    override func viewDidLoad() {
        super.viewDidLoad()
        label.text = "Você não tem livros cadastrados"
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        guard let books = fetchedResultController.fetchedObjects?[indexPath.row] else{
            return cell
        }
        
        cell.prepare(with: books)
        return cell
